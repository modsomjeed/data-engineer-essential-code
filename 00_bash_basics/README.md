...
### 5. Expected Output
```text
$ cut -d',' -f4 input/users.csv | tail -n +2 | sort | uniq -c
      7 free
      5 pro
      3 enterprise
```
...
### 5. Expected Output
```text
$ grep "ERROR" production/logs/pipeline_error.log
...
$ grep "O5832" production/data/failed_job.csv
